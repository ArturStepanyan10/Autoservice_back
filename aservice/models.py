...
class Appointment(models.Model):
    ...
    first_name = models.CharField(max_length=64, validators=[MinLengthValidator(2)], verbose_name='Имя')
    last_name = models.CharField(max_length=128, validators=[MinLengthValidator(2)], verbose_name='Фамилие')
